...
## Indice
1. [Quick Start — Avvio completo in locale](#0-quick-start)
2. [Overview architettura](#1-overview-architettura)
3. [Prerequisiti](#2-prerequisiti)
4. [Setup ambiente](#3-setup-ambiente)
5. [Componente 1: Fuzzy Edit Engine](#4-fuzzy-edit-engine)
6. [Componente 2: AI SDK Direct](#5-ai-sdk-direct)
7. [Componente 3: Provider Transform](#6-provider-transform)
8. [Componente 4: Coding Tools](#7-coding-tools)
9. [Componente 5: Coding Agent](#8-coding-agent)
10. [Componente 6: LSP Integration](#9-lsp-integration)
11. [Componente 7: MCP Server](#10-mcp-server)
12. [Componente 8: Cloud Sandbox (E2B)](#11-cloud-sandbox)
13. [Configurazione agente](#12-configurazione-agente)
14. [Test e verifica](#13-test-e-verifica)
15. [Troubleshooting](#14-troubleshooting)
16. [Costi e billing](#15-costi-e-billing)
...
```
  ...
  │ [admin@108labs.it](mailto:admin@108labs.it)</a>            │ changeme108! │ platform_admin │ Nessuno (accesso globale) │

  ├─────────────────────────────┼──────────────┼────────────────┼───────────────────────────┤

  │ [admin@demo-azienda.it](mailto:admin@demo-azienda.it)</a>       │ changeme108! │ tenant_admin   │ Demo Azienda S.r.l.       │

  ├─────────────────────────────┼──────────────┼────────────────┼───────────────────────────┤

  │ [mario.rossi@demo-azienda.it](mailto:mario.rossi@demo-azienda.it)</a> │ changeme108! │ client_user    │ Demo Azienda S.r.l.       │
