---
title: "Come Far Costruire il Tuo Software Senza Bruciare Soldi"
author: "108 Vision | Elios Scoglio"
type: "manuale-omaggio"
track: "sviluppo-progetto"
version: "2.0"
date: "2026-06-11"
---
...
|---|---|---|---|
| Freelancer | Rapporto diretto, costi contenuti, flessibilità | Rischio abbandono a progetto in corso, nessuna governance, nessun peer review sul codice | Progetti semplici e ben definiti, bassa complessità tecnica |
| Software house | Team strutturato, capacity garantita, processi definiti | Costo alto, ti assegnano spesso chi è disponibile invece del senior che ti ha venduto il progetto, comunicazione filtrata dal PM | Progetti ad alta complessità, timeline rigida, integrazione con sistemi enterprise |
| Boutique tecnica | Qualità tecnica alta, relazione diretta, attenzione al contesto | Capacity limitata, possibili colli di bottiglia su progetti grandi | Progetti di media complessità dove la qualità è critica e il budget è vincolato |
| Factory / team in retainer | Continuità, conoscenza del sistema nel tempo, evoluzione costante | Richiede impegno continuativo, non adatta a sviluppo una-tantum | Prodotti che evolvono nel tempo, aziende che hanno già software in produzione |
| Team interno | Controllo totale, conoscenza profonda del business | Costo fisso alto, difficile recruiting, rischio concentrazione know-how | Prodotto core aziendale con sviluppo continuo di lungo periodo |
...
Un progetto senza milestone è un progetto dove scopri i problemi solo alla consegna — quando è tardi e costoso correggere.
...
Le persone che useranno il software ogni giorno sanno cose che tu non sai. Non coinvolgerle nella raccolta dei requisiti è uno degli errori più costosi che un committente non tecnico possa fare.
...
Senza documentazione, tra sei mesi — che tu sia con lo stesso fornitore o con un altro — nessuno capirà come funziona il sistema. Ogni modifica sarà più rischiosa, ogni nuovo sviluppatore impiegherà settimane per orientarsi, ogni problema sarà più difficile da diagnosticare.
...
|---|---|---|
| Test automatici | "Ci sono test nel codice? Quale percentuale del codice è coperta da test?" | Se non ci sono test, ogni modifica rischia di rompere qualcosa che funzionava. Un software senza test è una macchina senza freni. |
| Deploy automatizzato | "Come va il software in produzione?" | Se la risposta è "carichiamo i file manualmente", hai un processo rischioso, non ripetibile, e dipendente da una persona specifica. |
| Monitoraggio | "Come sapete se qualcosa non funziona?" | Se la risposta è "ce lo dicono gli utenti", il tuo sistema non ha allerta preventiva. I problemi li scopri quando il danno è già fatto. |
| Backup dei dati | "I dati degli utenti sono backuppati? Con quale frequenza? Dove?" | Se non c'è una risposta chiara e documentata, c'è un rischio reale di perdita irreversibile dei dati. |
| Sicurezza | "Avete fatto una revisione di sicurezza? Come vengono gestite le password degli utenti?" | Se la risposta è vaga o sorpresa, stai costruendo qualcosa che potrebbe esporre i dati tuoi o dei tuoi clienti. |
...
**Fase 1 — Setup e fondamenta (una-due settimane)**
...
Il cuore del progetto. Ogni sprint produce funzionalità testabili, con demo al termine. Tu vedi il lavoro, fornisci feedback, il team integra le correzioni nel prossimo sprint. Non aspettare l'ultimo sprint per fare domande o sollevare problemi — il costo di correggere cresce ad ogni settimana di ritardo.
