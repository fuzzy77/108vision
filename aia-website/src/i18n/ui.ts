...
const ui = {
  it: {
    ...
    contactForm: {
      ...
      placeholderMessage: 'Descrivi brevemente la tua esigenza...',
    ...
    contact: {
      title: 'Contatti',
      metaDescription:
        'Prenota una call gratuita di 30 minuti o invia un messaggio. Rispondo entro un giorno lavorativo.',
      heading: 'Parliamone',
      intro:
        'Prenota una call gratuita di 30 minuti o invia un messaggio. Rispondo entro un giorno lavorativo.',
    ...
    service: {
      ...
      downloadGuideDesc:
        'Ricevi il PDF con framework, checklist e casi studio reali. Nessuna email richiesta.',
  ...
  en: {
    ...
    contactForm: {
      ...
      placeholderMessage: 'Briefly describe your need...',
    ...
    contact: {
      title: 'Contact',
      metaDescription:
        'Book a free 30-minute call or send a message. I reply within one business day.',
      heading: "Let's talk",
      intro:
        'Book a free 30-minute discovery call or send me a message. I reply within one business day.',
    ...
    service: {
      ...
      downloadGuideDesc:
        'Get the PDF with frameworks, checklists, and real case studies. No email required.',
