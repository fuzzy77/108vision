...
import type { ExperienceItem, SkillGroup } from './chi-siamo';
...
const content: LocaleContent<ChiSonoContent> = {
  it: {
    meta: {
      title: 'Chi Sono',
      description:
        'Elios Scoglio - 15+ anni in architettura software, AI e trasformazione digitale. Software & Architecture Manager per enterprise e consulente per PMI.',
    },
    breadcrumb: 'Chi Sono',
    hero: {
      founderLabel: 'Elios Scoglio',
      title: 'Elios Scoglio',
      subtitle: 'Software & Architecture Manager | AI Consultant',
      paragraphs: [
    ...
    skills: {
      ...
      groups: [
        { title: 'Architettura Software', items: ['Microservizi, DDD, Event-Driven', '.NET, Java, Spring Boot', 'Cloud-Native, Kubernetes', 'API Design (REST, gRPC, GraphQL)'] },
        ...
        { title: 'Domain Expertise', items: ['Ticketing & Live Entertainment', 'E-Commerce & Payments', 'Compliance Fiscale (SIAE)', 'Pubblica Amministrazione'] },
        { title: 'Metodologie', items: ['Agile (Scrum, Kanban, pragmatic)', 'SOLID, Clean Architecture', 'TDD, BDD', 'ADR, Design Docs'] },
      ],
    },
    philosophy: {
  ...
  en: {
    meta: {
      title: 'Who I Am',
      description:
        'Elios Scoglio - 15+ years in software architecture, AI, and digital transformation. Software & Architecture Manager for enterprises and consultant for SMEs.',
    },
    breadcrumb: 'Who I Am',
    hero: {
      founderLabel: 'Elios Scoglio',
      ...
      paragraphs: [
        ...
        'As Software & Architecture Manager for TicketOne/Eventim Italy, I manage the evolution of a platform that sells millions of tickets annually, with scalability, security, and compliance constraints that leave no room for error.',
...
export function getChiSonoContent(locale: Locale): ChiSonoContent {
