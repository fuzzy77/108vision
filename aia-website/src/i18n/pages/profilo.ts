...
const profilo: Record<Locale, Record<ProfiloSlug, ProfiloContent>> = {
  it: {
    'full-stack-ai': {
      ...
      cvDescription: 'PDF aggiornato con focus AI: esperienze, stack e capacità applicate al delivery e ai prodotti.',
      cvButton: 'Scarica PDF',
      cvPath: '/cv/Elios_Scoglio_CV_FullStackAI_V2.pdf',
    ...
    'software-manager': {
      ...
      cvTitle: 'Scarica il CV completo',
      cvDescription: 'PDF aggiornato con focus AI: governance del delivery, architettura e capacità AI di prodotto.',
      cvButton: 'Scarica PDF',
      cvPath: '/cv/Elios_Scoglio_CV_SoftwareManager_V2.pdf',
      contactTitle: 'Interessato a questo profilo?',
      contactSubtitle: 'Compila il form e ti rispondo entro 24 ore.',
    ...
    'team-leader': {
      ...
      cvTitle: 'Scarica il CV completo',
      cvDescription: 'PDF aggiornato con focus AI: leadership tecnica, delivery assistito e AI di prodotto.',
      cvButton: 'Scarica PDF',
      cvPath: '/cv/Elios_Scoglio_CV_TeamLeader_V2.pdf',
      contactTitle: 'Interessato a questo profilo?',
      contactSubtitle: 'Compila il form e ti rispondo entro 24 ore.',
  ...
  en: {
    'full-stack-ai': {
      ...
      cvDescription: 'Updated PDF with AI focus: experience, stack, and applied AI for delivery and products.',
    ...
    'software-manager': {
      ...
      cvTitle: 'Download full CV',
      cvDescription: 'Updated PDF with AI focus: delivery governance, architecture, and product AI capabilities.',
      cvButton: 'Download PDF',
      cvPath: '/cv/Elios_Scoglio_CV_SoftwareManager_V2.pdf',
      contactTitle: 'Interested in this profile?',
      contactSubtitle: 'Fill in the form and I will reply within 24 hours.',
    ...
    'team-leader': {
      ...
      cvTitle: 'Download full CV',
      cvDescription: 'Updated PDF with AI focus: technical leadership, AI-assisted delivery, and product AI.',
      cvButton: 'Download PDF',
      cvPath: '/cv/Elios_Scoglio_CV_TeamLeader_V2.pdf',
      contactTitle: 'Interested in this profile?',
      contactSubtitle: 'Fill in the form and I will reply within 24 hours.',
